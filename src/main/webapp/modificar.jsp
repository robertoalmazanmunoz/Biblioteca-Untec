...
<title>Modificar Libro | Biblioteca Digital UNTEC</title>
</head>
<body>
			...
			<div class="col-md-6">
				<div class="card shadow">
					<div class="card-header bg-primary text-white">
						<h2 class="card-title">Modificar Libro UNTEC</h2>
					</div>
					<div class="card-body">
						...
						<form action="${pageContext.request.contextPath}/ModificarLibro" method="post">
